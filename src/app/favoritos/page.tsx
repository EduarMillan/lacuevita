...
export default function FavoritosPage() {
  return (
    <>
      <section className="relative overflow-hidden bg-gradient-to-br from-rose-400 via-pink-400 to-fuchsia-400">
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10 max-w-7xl mx-auto relative z-10">
          ...
          <div className="mt-3 max-w-3xl">
            <div className="inline-flex items-center gap-2 bg-white/30 backdrop-blur-md px-3 sm:px-4 py-1.5 rounded-full mb-3">
              <span
                className="material-symbols-outlined text-rose-900 text-lg"
                style={{ fontVariationSettings: "'FILL' 1" }}
              >
                favorite
              </span>
              <span className="text-sm font-semibold text-rose-900 tracking-wide">
                Tus guardados
              </span>
            </div>
            <h1 className="text-3xl sm:text-4xl lg:text-6xl font-black tracking-tight text-white mb-2 leading-[1.1]">
              Mis <span className="text-rose-800">Favoritos</span>
            </h1>
            <p className="text-sm sm:text-lg text-rose-900/80 max-w-xl leading-relaxed">
              Los anuncios que guardaste para revisar después.
            </p>
          </div>
        </div>
      </section>
